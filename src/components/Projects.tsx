...
const projects: Project[] = [
  {
    title: 'IKEA Payments',
    description: 'Integrated TP.Net Tills with IKEA systems. Built a log parser tool that reduced POS transaction recovery time by 40%. (Java, Spring Boot, Microservices, Spring Cloud, Spring Security)',
    github: '',
    demo: '',
  },
  {
    title: 'NetPeace',
    description: 'Developed AI-powered, self-healing network automation interface. Improved UX by 25%, onboarding time by 15%, and resolution time by 50%. (React, JavaScript)',
    github: '',
    demo: '',
  },
];
    ...
    <Container sx={{ py: 6, position: 'relative' }}>
      ...
      <Box sx={{
        ...
        <svg width="320" height="180" viewBox="0 0 320 180" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="projGrad" x1="0" y1="0" x2="320" y2="180" gradientUnits="userSpaceOnUse">
              <stop stop-color="#7f5af0" />
              <stop offset="1" stop-color="#2cb67d" />
            </linearGradient>
          </defs>
          <ellipse cx="160" cy="90" rx="140" ry="60" fill="url(#projGrad)">
            <animate attributeName="rx" values="140;120;140" dur="6s" repeatCount="indefinite" />
          ...
          <Grid item xs={12} md={4} key={project.title}>
            ...
            >
              ...
              <CardContent sx={{ flexGrow: 1 }}>
                <Typography variant="h6" fontWeight={700} sx={{ fontFamily: 'Space Grotesk, sans-serif', mb: 1 }}>
                  {project.title}
                </Typography>
                ...
                {project.github && (
                  <Button
                    ...
                    sx={{
                      ...
                      textTransform: 'none',
                      '&:hover': { color: '#fff', background: 'rgba(0,0,0,0.08)' },
                    }}
                  >
                    GitHub
                  </Button>
                ...
                {project.demo && (
                  <Button
                    ...
                    sx={{
                      ...
                      fontFamily: 'Space Grotesk, sans-serif',
                      textTransform: 'none',
                      '&:hover': { color: '#fff', background: 'rgba(44,182,125,0.12)' },
                    }}
                  >
                    Live Demo
                  </Button>
